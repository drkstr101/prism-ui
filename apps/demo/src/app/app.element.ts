    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            <a id="nx-console" class="button-pill bg-background-layer-2 rounded shadow" href="https://marketplace.visualstudio.com/items?itemName=nrwl.angular-console&utm_source=nx-project" target="_blank" rel="noreferrer">
              <svg
                fill="currentColor"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a
                ...
                class="button-pill rounded shadow bg-background-layer-2"
            ...
            <div id="nx-cloud" class="rounded shadow bg-background-layer-2">
              <div>
            ...
            <a id="nx-repo" class="button-pill rounded shadow bg-background-layer-2" href="https://github.com/nrwl/nx?utm_source=nx-project" target="_blank" rel="noreferrer">
              <svg
                fill="currentColor"
                role="img"
                viewBox="0 0 24 24"
        ...
        <!--  COMMANDS  -->
        <div id="commands" class="rounded shadow bg-background-layer-2">
          <h2>Next steps</h2>
