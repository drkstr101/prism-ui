...
export const mainSection = () => PageElement.located(By.css('.main')).describedAs('main section');

export const footerSection = () =>
  PageElement.located(By.css('.footer')).describedAs('footer section');
...
export const outstandingItemsCount = () =>
  Text.of(PageElement.located(By.tagName('strong')).of(outstandingItemsLabel()))
    .as(Number)
...
export const clearCompletedButton = () =>
  PageElement.located(By.css('.clear-completed')).describedAs('clear completed button');
...
export const toggleAllButton = () =>
  PageElement.located(By.id('toggle-all')).describedAs('toggle all button');
